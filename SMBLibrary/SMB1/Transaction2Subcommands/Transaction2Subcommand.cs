            ...
            if (setup.Length == 2)
            {
                ...
                switch (subcommandName)
                {
                    ...
                    case Transaction2SubcommandName.TRANS2_QUERY_FS_INFORMATION:
                        return new Transaction2QueryFSInformationRequest(parameters);

                    case Transaction2SubcommandName.TRANS2_SET_FS_INFORMATION:
                        return new Transaction2SetFSInformationRequest(parameters, data);
                    ...
                    case Transaction2SubcommandName.TRANS2_QUERY_FILE_INFORMATION:
                        return new Transaction2QueryFileInformationRequest(parameters, data);

                    case Transaction2SubcommandName.TRANS2_SET_FILE_INFORMATION:
                        return new Transaction2SetFileInformationRequest(parameters, data);
